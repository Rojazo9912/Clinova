...
export default function InitialEvaluationWizard({ isOpen, onClose, onSuccess, patientId, patientName, patientAge }: Props) {
    const {
        step, setStep, loading, initials, canProceed, handleFinish,
        chiefComplaint, setChiefComplaint, bodyRegion, setBodyRegion,
        onsetDuration, setOnsetDuration, painOnset, setPainOnset, worseAt, setWorseAt,
        chronicConditions, toggleCondition, previousSurgeries, setPreviousSurgeries,
        currentMedications, setCurrentMedications, allergies, setAllergies,
        previousPhysio, setPreviousPhysio,
        initialPain, setInitialPain, posture, setPosture, romNotes, setRomNotes,
        strengthNotes, setStrengthNotes, examFindings, setExamFindings,
        diagnosis, setDiagnosis, goals, addGoal, removeGoal, updateGoal,
        planTitle, setPlanTitle, totalSessions, setTotalSessions, frequency, setFrequency,
        sessionPrice, setSessionPrice, packagePrice, setPackagePrice, startDate, setStartDate,
    } = useEvaluationWizard({ patientId, patientName, onSuccess })
