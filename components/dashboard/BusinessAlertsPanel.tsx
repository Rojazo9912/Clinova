        ...
        <div className="rounded-2xl bg-white border border-slate-100 shadow-sm overflow-hidden">
            ...
            <div className="grid sm:grid-cols-3 divide-y sm:divide-y-0 sm:divide-x divide-slate-100">
                ...
                <Link
                    ...
                    className="flex items-center gap-4 p-5 hover:bg-orange-50/60 transition-colors group"
                >
                    <div className={`text-3xl select-none ${pendingAmount > 0 ? '' : 'grayscale'}`}>
                        💵
                    </div>
                    <div className="flex-1 min-w-0">
                        <p className="text-xs text-slate-500 font-medium mb-0.5">Cobros pendientes</p>
                ...
                <Link
                    ...
                    className="flex items-center gap-4 p-5 hover:bg-amber-50/60 transition-colors group"
                >
                    <div className={`text-3xl select-none ${inactivePatients === 0 ? 'grayscale' : ''}`}>
                        🙋
                    </div>
                    <div className="flex-1 min-w-0">
                        <p className="text-xs text-slate-500 font-medium mb-0.5">Pacientes inactivos</p>
                ...
                <div className="flex items-center gap-4 p-5">
                    ...
                    <div className="flex-1 min-w-0">
                        <p className="text-xs text-slate-500 font-medium mb-0.5">Tasa de asistencia</p>
